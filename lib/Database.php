...
class DataBase{
    ...
    // These two functions don't really do anything different to the insert function
    // It was visually weird to see the insert function called to execute an update/delete statement however
